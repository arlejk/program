...
const ottLinkMap = {
    '크라임씬 제로': {
		...
		'YOUTUBE': 'https://youtube.com/playlist?list=PLL1qZqiuec_T6j5qVdsx6Hdnlu-3PGT49&si=7UIC81DoGgKNETCP'
    },
	'크라임씬 리턴즈': {
        'TVING': 'https://www.tving.com/contents/P001751684',
		'YOUTUBE': 'https://youtube.com/playlist?list=PLGmQK4hT0kOb44PgcaLwkRNdlmMDL3t8W&si=J9gkzDNyWdFwXobP'
    },
	'크라임씬 3': {
        'TVING': 'https://www.tving.com/contents/P000539639',
        'NETFLIX': 'https://www.netflix.com/kr/title/82660827#season03',
		'YOUTUBE': 'https://youtube.com/playlist?list=PLis5WuyWOdrXqtkDLGwVeqzNzkr16gdHL&si=sl5C_jrIKQinJaYd'
    },
	'크라임씬 2': {
    ...
    crimeScene: [
		{
			...
			broadcaster: "NETFLIX",
			year: "2025",
			otts: ["NETFLIX", "YOUTUBE"],
			epNum: "1",
			epTitle: "폐병원 살인사건",
			victim: "장제인",
			detective: "장탐정 (장진)",
			suspects: ["박접신 (박지윤)", "장사촌 (장동민)", "김미남 (김지훈)", "안의사 (안유진)"],
			guests: ["박이장 (박성웅)"],
		...
		},
		{
			...
			victim: "박소윤",
			detective: "김탐정 (김지훈)",
			suspects: ["박카라 (박지윤)", "장절친 (장진)", "장이웃 (장동민)", "안메리 (안유진)"],
			guests: ["황갑부 (황인엽)"]
		},
		{
			season: "크라임씬 제로",
		...
		},
		{
			...
			victim: "황슬우",
			detective: "키경찰 (KEY)",
			suspects: ["박주인 (박지윤)", "장슈퍼 (장진)", "장일용 (장동민)", "안래퍼 (안유진)", "주만년 (주현영)"],
			guests: [],
			rowClass: "table-primary"
		},
		{
		...
		},
		{
			...
			victim: "전민교",
			detective: "장탐정 (장동민)",
			suspects: ["박증인 (박지윤)", "장아빠 (장진)", "안기자 (안유진)", "주변호 (주현영)", "키보안 (KEY)"],
			guests: []
		},
		{
			season: "크라임씬 리턴즈",
		...
		},
		{
			...
			victim: "신교주",
			detective: "안탐정 (안유진)",
			suspects: ["박기생 (박지윤)", "장뚝딱 (장진)", "장의사 (장동민)", "주모던 (주현영)", "키맹신 (KEY)"],
			guests: [],
			rowClass: "table-primary"
		},
		{
...

		{
			...
			epNum: "1",
			epTitle: "대선 후보 살인사건",
			link: "https://youtu.be/S7duktmOZIg?si=_ftwVt8PZR88ZU-N",
			victim: "정동필",
			detective: "김지훈",
			suspects: ["박보좌 (박지윤)", "장후보 (장진)", "양알바 (양세형)", "정사모 (정은지)"],
			guests: ["송대표 (송재림)"],
			unreleased: ["https://youtu.be/XErN6PHAsNw", "https://youtu.be/V3lHmTBf8os"]
		},
		{
			season: "크라임씬 3",
			broadcaster: "JTBC",
			...
			epNum: "2",
			epTitle: "스타 셰프 살인사건",
			link: "https://youtu.be/fxRou2Ds9nQ?si=TbKlflCXCWUF_xLy",
			victim: "최우진",
			detective: "양세형",
			suspects: ["박배우 (박지윤)", "장막내 (장진)", "김오너 (김지훈)", "정서빙 (정은지)"],
			guests: ["송부솊 (송재림)"],
			unreleased: ["https://youtu.be/3rJ0NFcx1sg", "https://youtu.be/w3hr5uzNnes"]
		},
		{
			season: "크라임씬 3",
			broadcaster: "JTBC",
			...
			epNum: "3",
			epTitle: "경찰학교 살인사건",
			link: "https://youtu.be/F5UXpiQeDRc?si=DsDoiGs0iYBljmV8",
			victim: "정종찬",
			detective: "장진",
		...
		},
		{
			...
			epNum: "4",
			epTitle: "사기꾼 살인사건",
			link: "https://youtu.be/0cY9UI3hfE4?si=1BJZfMZJ_e__Baor",
			victim: "장영창",
			detective: "정은지",
			suspects: ["박형사 (박지윤)", "장비서 (장진)", "김팀장 (김지훈)", "양형사 (양세형)"],
			guests: ["김동포 (김병옥)"],
			unreleased: ["https://youtu.be/jje7VToCPY0", "https://youtu.be/b6d8m4JTVHY"]
		},
		{
			season: "크라임씬 3",
			broadcaster: "JTBC",
			...
			epNum: "5",
			epTitle: "뮤지컬 배우 살인사건",
			link: "https://youtu.be/HG7KtxY5dJ8?si=r3p7JGhPF5uGk985",
			victim: "노미오",
			detective: "양세형",
			suspects: ["박리엣 (박지윤)", "장감독 (장진)", "김관객 (김지훈)", "정대표 (정은지)"],
			guests: ["진스타 (진영)"],
			unreleased: ["https://youtu.be/Ras5qsQYhSc", "https://youtu.be/yaaggtDR6ds", "https://youtu.be/sBum4-dZkVY"]
		},
		{
			season: "크라임씬 3",
			broadcaster: "JTBC",
			...
			epNum: "6",
			epTitle: "숙다방 살인사건",
			link: "https://youtu.be/97tieGyJtMY?si=KefqQSiunM8HHN18",
			victim: "이은숙",
			detective: "박지윤",
			suspects: ["디제이장 (장진)", "김화백 (김지훈)", "정숙녀 (정은지)"],
			guests: ["미스소 (소진)", "장당포 (장동민)"],
			unreleased: ["https://youtu.be/c2CF0ja8PYs", "https://youtu.be/KIyXvMqk1Gc", "https://youtu.be/kK_hjz_KP30", "https://youtu.be/LuLlOT9MT14", "https://youtu.be/EnuQWqmcm7c", "https://youtu.be/gaoeKja1tRE"],
			rowClass: "table-primary"
		},
		{
			season: "크라임씬 3",
			...
			epNum: "7",
			epTitle: "캠핑장 살인사건",
			link: "https://youtu.be/3ERbGmOhFLA?si=5RCXq6n6dbI5TAkM",
			victim: "박지윤",
			detective: "박지윤",
			suspects: ["장진 (장진)", "김지훈 (김지훈)", "양세형 (양세형)", "정은지 (정은지)"],
			guests: ["차은우 (차은우)"],
			unreleased: ["https://youtu.be/QiTelAN4wLg", "https://youtu.be/LkP2d-MproI", "https://youtu.be/dp7W_8J_cV8", "https://youtu.be/YDS63NNe3UI", "https://youtu.be/eV-NX5SCZcA"],
			rowClass: "table-primary"
		},
		{
			season: "크라임씬 3",
			...
			guests: [],
			unreleased: ["https://youtu.be/F7y4qneYQ4s", "https://youtu.be/kbWVBr3sUHE", "https://youtu.be/Bic-7zrB8-k", "https://youtu.be/UjuEOG2bQPY", "https://youtu.be/3LKUzR8O7MI"],
			rowClass: "table-primary"
		},
		{
			season: "크라임씬 3",
			...
			epNum: "9",
			epTitle: "대저택 살인사건",
			link: "https://youtu.be/SRMqUT8IFms?si=cb6Xa4k8W2VAebsd",
			victim: "장세민",
			detective: "장진",
			suspects: ["박케어 (박지윤)", "홍변호 (홍진호)", "양손님 (양세형)", "정손녀 (정은지)"],
			guests: ["장아들 (장동민)"],
			unreleased: ["https://youtu.be/-5XJs_n5yw8", "https://youtu.be/CT03FK8R9EQ", "https://youtu.be/uyRmeMlsdOM", "https://youtu.be/jCLwIPXvtyk"],
			rowClass: "table-primary"
		},
		{
			season: "크라임씬 3",
		...
		},
		{
			...
			epNum: "11",
			epTitle: "섬마을 살인사건",
			link: "https://youtu.be/N5WF0K9xkJE?si=Ra2qx5B6w-mQRDdF",
			victim: "조유림",
			detective: "양세형",
			suspects: ["박해녀 (박지윤)", "장통통 (장진)", "홍구녕 (홍진호)", "정토박 (정은지)"],
			guests: ["소이장 (소진)"],
			unreleased: ["https://youtu.be/VLiajbAm_ps", "https://youtu.be/fQx1eQEvqxs", "https://youtu.be/mL9iNd7kZ4o", "https://youtu.be/JSQNIXXghMU", "https://youtu.be/ELFyE3qn6_U"],
			rowClass: "table-primary"
		},
		{
			season: "크라임씬 3",
			...
			otts: ["TVING", "NETFLIX"],
			epNum: "12",
			epTitle: "크라임씬 작가 살인사건",
			link: "https://youtu.be/Fi9fxzwj-So?si=L3JGXA_QA0pDYTMV",
			victim: "최수진",
			detective: "",
			suspects: ["박지윤 (박지윤)", "장진 (장진)", "홍진호 (홍진호)", "김지훈 (김지훈)", "양세형 (양세형)", "정은지 (정은지)"],
			guests: [],
			unreleased: ["http://tv.naver.com/v/1858701", "https://youtu.be/c3JEE2SkXtg", "http://tv.naver.com/v/1861715"]
		},
		{
			season: "크라임씬 2",
			broadcaster: "JTBC",
			...
			epNum: "1",
			epTitle: "갤러리 살인사건",
			link: "https://youtu.be/MpLMvAFNLgU?si=jrI9ASnIM6xrRVzf",
			victim: "심화나",
			detective: "장진",
			suspects: ["박관장 (박지윤)", "홍화가 (홍진호)", "장딜러 (장동민)", "하고객 (하니)"],
			guests: ["김경비 (김지훈)"]
		},
		{
			season: "크라임씬 2",
			...
			epNum: "2",
			epTitle: "통닭집 살인사건",
			link: "https://youtu.be/IVo9NGg4K-U?si=wMClLTFGKe1shoj5",
			victim: "김재원",
			detective: "박지윤",
		...
		},
		{
			...
			epNum: "3",
			epTitle: "미인대회 살인사건",
			link: "https://youtu.be/Katn_YDQbsU?si=YAskqiDWW1EgfVIm",
			victim: "박혜리",
			detective: "장동민",
		...
		},
		{
			...
			otts: ["TVING", "NETFLIX"],
			epNum: "4",
			epTitle: "재벌가 여대생 살인사건",
			link: "https://youtu.be/B430Q5u8Qvk?si=1P0E89VNdkcLR8bg",
			victim: "김재희",
			detective: "하니",
		...
		},
		{
			...
			unreleased: ["https://youtu.be/UTQ69j3aSTY", "https://youtu.be/K4RQFsbauGM"]
		},
		{
			season: "크라임씬 2",
			broadcaster: "JTBC",
			...
			epNum: "6",
			epTitle: "크루즈 살인사건",
			link: "https://youtu.be/Tgkh1Ly_3q0?si=IqLg7zBE0kqdEQCO",
			victim: "유기환",
			detective: "장진",
			suspects: ["박재즈 (박지윤)", "홍선장 (홍진호)", "장항해 (장동민)", "하승무원 (하니)"],
			guests: ["시매니저 (시우민)"],
			unreleased: ["https://youtu.be/lF72ghIOSjk", "https://youtu.be/rTBNoYj4D2M", "https://youtu.be/ahHXYDZ-SuM"],
			rowClass: "table-primary"
		},
		{
			season: "크라임씬 2",
			...
			epNum: "7",
			epTitle: "크루즈 살인사건",
			link: "https://youtu.be/ZzSSUwxGMog?si=bkxmU76ijNOnA-ZP",
			victim: "홍선장 (홍진호)",
			detective: "장진",
			suspects: ["박재즈 (박지윤)", "장항해 (장동민)", "하승무원 (하니)"],
			guests: ["윤부인 (NS윤지)", "홍포터 (강민혁)"],
			unreleased: ["https://youtu.be/OfQFafZEMPI", "https://youtu.be/Jb8A45PkxiE", "https://youtu.be/aiIdzW_qS8U"],
			rowClass: "table-primary"
		},
		{
			season: "크라임씬 2",
			...
			epNum: "8",
			epTitle: "804호 살인사건",
			link: "https://youtu.be/C2Usj1XBD0Q?si=ps5JTA-9X3NLM6uW",
			victim: "김혜림",
			detective: "장동민",
			suspects: ["박사지 (박지윤)", "장옆집 (장진)", "장진호 (홍진호)", "전하니 (하니)"],
			guests: ["전남편 (전현무)"],
			unreleased: ["https://youtu.be/mvpitWJfuNc", "https://youtu.be/AzQVys-X1fA"]
		},
		{
			season: "크라임씬 2",
			broadcaster: "JTBC",
			...
			epNum: "9",
			epTitle: "교차로 살인사건",
			link: "https://youtu.be/l0sQp4w-Cp0?si=ozt2MAWRFPbgNARI",
			victim: "민소영",
			detective: "박지윤",
			suspects: ["장순정 (장진)", "홍정비 (홍진호)", "장대리 (장동민)", "하선녀 (하니)"],
			guests: ["권동기 (권보아)"],
			unreleased: ["https://youtu.be/nj6VMPQXEoc", "https://youtu.be/AkQfNz8TnB0"]
		},
		{
			season: "크라임씬 2",
			broadcaster: "JTBC",
			...
			epNum: "10",
			epTitle: "산장 살인사건",
			link: "https://youtu.be/sB6zyD1uSew?si=3dqGbrdoelbM7job",
			victim: "이재기",
			detective: "홍진호",
			suspects: ["박요염 (박지윤)", "장포악 (장진)", "장미숙 (장동민)", "하고독 (하니)"],
			guests: ["김순진 (김지훈)"],
			unreleased: ["https://youtu.be/X_CMat-U0Uw"],
			rowClass: "table-primary"
		},
		{
			season: "크라임씬 2",
			...
			otts: ["TVING", "NETFLIX"],
			epNum: "11",
			epTitle: "크라임씬 PD 살인사건",
			link: "https://youtu.be/c2z12W5u0QA?si=3Q7Lx1Z1af64Omt5",
			victim: "윤현준",
			detective: "표창원",
			suspects: ["박지윤 (박지윤)", "장진 (장진)", "장동민 (장동민)", "홍진호 (홍진호)", "하니 (하니)"],
			guests: [],
			unreleased: ["https://youtu.be/g_-IRrc6gdA"]
		},
		{
			season: "크라임씬 2",
			broadcaster: "JTBC",
			...
			suspects: ["박지윤 (박지윤)", "장진 (장진)", "장동민 (장동민)", "홍진호 (홍진호)", "하니 (하니)"],
			guests: [],
			unreleased: ["https://youtu.be/qoUNnOdSfAU"]
		},
	
		{
			...
			epNum: "1",
			epTitle: "이덕만 회장 살인사건",
			link: "https://youtu.be/EdkX6Xo2YIc?si=h78-hiGg3F6U33Rx",
			victim: "이덕만",
			detective: "",
		...
		},
		{
			...
			epNum: "3",
			epTitle: "미술실 살인사건",
			link: "https://youtu.be/_7x5YjnHBQM?si=Ckxs8Iw5aHtfYuGy",
			victim: "세라",
			detective: "",
		...
		},
		{
			...
			epNum: "5",
			epTitle: "이팀장 살인사건",
			link: "https://youtu.be/RmzHpuJbEIU?si=w57MiduBWtBpG5r-",
			victim: "이상미",
			detective: "임문규",
		...
		},
		{
			...
			epNum: "7",
			epTitle: "교도소 살인사건",
			link: "https://youtu.be/YUXBPNAaMNQ?si=3oNaK_jdL1tTPif2",
			victim: "이창우",
			detective: "",
		...
		},
		{
			...
			epNum: "8",
			epTitle: "고여사 살인사건",
			link: "https://youtu.be/00H0PE9HsM4?si=-NE011hV7xT6olyg",
			victim: "고혜진",
			detective: "",
		...
		},
		{
			...
			epNum: "9",
			epTitle: "축구장 살인사건",
			link: "https://youtu.be/sMl0r_xpF78?si=RuPiHaVYgW6F1-I0",
			victim: "신영광",
			detective: "",
		...
		},
		{
			...
			epNum: "10",
			epTitle: "여배우 살인사건",
			link: "https://youtu.be/JzkpJeOfNHU?si=PyjD9H0CAK-7KY5Y",
			victim: "전효진",
			detective: "임문규",
...
function renderTable(containerId, list) {
    ...
    filteredList.forEach(item => {
        ...
        // 1) 미공개 영상(unreleased) HTML 생성
        let unreleasedHtml = '';
        if (Array.isArray(item.unreleased) && item.unreleased.length > 0) {
            unreleasedHtml = item.unreleased.map((url, idx) => `
                <a href="${url}" target="_blank" class="btn btn-outline-dark btn-sm">
                    <i class="fa-solid fa-video"></i> 클립 #${idx + 1}
                </a>
            `).join(' ');
        }
