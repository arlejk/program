...
// 7. 테이블 렌더링 함수 (renderCastTag 호출 시 item.epTitle 인자 전달 수정완료)
function renderTable(containerId, list) {
    ...
    filteredList.forEach(item => {
        ...
        // [핵심 수정] renderCastTag 호출 시 item.epTitle을 두 번째 인자로 전달
