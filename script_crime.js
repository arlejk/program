...
const programData = {
    crimeScene: [
        ...
        { season: "크라임씬 1", broadcaster: "JTBC", year: "2014", otts: [ "TVING", "NETFLIX" ], epNum: "10", epTitle: "여배우 살인사건", victim: "전효진", detective: "임문규", suspects: ["박엔터 (박지윤)", "홍소품 (홍진호)", "전스타 (전현무)", "윤조연 (NS윤지)", "강제작 (강용석)"], guests: ["민감독 (강민혁)"] },
        ...
        { season: "크라임씬 2", broadcaster: "JTBC", year: "2015", otts: [ "TVING", "NETFLIX" ], epNum: "2", epTitle: "통닭집 살인사건", victim: "김재원", detective: "박지윤", suspects: ["장책방 (장진)", "홍상회 (홍진호)", "장고물 (장동민)", "하부인 (하니)"], guests: ["김일꾼 (김지훈)"] },
        { season: "크라임씬 2", broadcaster: "JTBC", year: "2015", otts: [ "TVING", "NETFLIX" ], epNum: "3", epTitle: "미인대회 살인사건", victim: "박혜리", detective: "장동민", suspects: ["박미녀 (박지윤)", "장심사 (장진)", "홍기자 (홍진호)", "하백조 (하니)"], guests: ["오원장 (오현경)"] },
        ...
        { season: "크라임씬 2", broadcaster: "JTBC", year: "2015", otts: [ "TVING", "NETFLIX" ], epNum: "6", epTitle: "크루즈 살인사건", victim: "유기환", detective: "장진", suspects: ["박재즈 (박지윤)", "홍선장 (홍진호)", "장항해 (장동민)", "하승무원 (하니)"], guests: ["시매니저 (시우민)"] },
        { season: "크라임씬 2", broadcaster: "JTBC", year: "2015", otts: [ "TVING", "NETFLIX" ], epNum: "7", epTitle: "크루즈 살인사건", victim: "홍선장 (홍진호)", detective: "장진", suspects: ["박재즈 (박지윤)", "장항해 (장동민)", "하승무원 (하니)"], guests: ["윤부인 (NS윤지)", "홍포터 (강민혁)"] },
        ...
        { season: "크라임씬 2", broadcaster: "JTBC", year: "2015", otts: [ "TVING", "NETFLIX" ], epNum: "10", epTitle: "산장 살인사건", victim: "이재기", detective: "홍진호", suspects: ["박요염 (박지윤)", "장포악 (장진)", "장미숙 (장동민)", "하고독 (하니)"], guests: ["김순진 (김지훈)"] },
        ...
        { season: "크라임씬 3", broadcaster: "JTBC", year: "2017", otts: [ "TVING", "NETFLIX" ], epNum: "6", epTitle: "숙다방 살인사건", victim: "이은숙", detective: "박지윤", suspects: ["디제이장 (장진)", "김화백 (김지훈)", "정숙녀 (정은지)"], guests: ["미스소 (소진)", "장당포 (장동민)"] },
        { season: "크라임씬 3", broadcaster: "JTBC", year: "2017", otts: [ "TVING", "NETFLIX" ], epNum: "7", epTitle: "캠핑장 살인사건", victim: "박지윤", detective: "박지윤", suspects: ["장진 (장진)", "김지훈 (김지훈)", "양세형 (양세형)", "정은지 (정은지)"], guests: ["차은우 (차은우)"] },
        { season: "크라임씬 3", broadcaster: "JTBC", year: "2017", otts: [ "TVING", "NETFLIX" ], epNum: "8", epTitle: "과학고 연쇄살인사건", victim: "김다래 / 김희연 / 김지선", detective: "홍진호", suspects: ["박지윤 (박지윤)", "장진 (장진)", "김지훈 (김지훈)", "양세형 (양세형)", "정은지 (정은지)"], guests: [] },
        { season: "크라임씬 3", broadcaster: "JTBC", year: "2017", otts: [ "TVING", "NETFLIX" ], epNum: "9", epTitle: "대저택 살인사건", victim: "장세민", detective: "장진", suspects: ["박케어 (박지윤)", "홍변호 (홍진호)", "양손님 (양세형)", "정손녀 (정은지)"], guests: ["장아들 (장동민)"] },
        { season: "크라임씬 3", broadcaster: "JTBC", year: "2017", otts: [ "TVING", "NETFLIX" ], epNum: "10", epTitle: "호텔 살인사건", victim: "장성규", detective: "표창원", suspects: ["박청소 (박지윤)", "장사업 (장진)", "홍단골 (홍진호)", "김건반 (김지훈)", "정텐더 (정은지)"], guests: [] },
        { season: "크라임씬 3", broadcaster: "JTBC", year: "2017", otts: [ "TVING", "NETFLIX" ], epNum: "11", epTitle: "섬마을 살인사건", victim: "조유림", detective: "양세형", suspects: ["박해녀 (박지윤)", "장통통 (장진)", "홍구녕 (홍진호)", "정토박 (정은지)"], guests: ["소이장 (소진)"] },
        ...
        { season: "크라임씬 리턴즈", broadcaster: "TVING", year: "2024", otts: ["TVING"], epNum: "3", epTitle: "고시원 살인사건", victim: "황슬우", detective: "키경찰 (KEY)", suspects: ["박주인 (박지윤)", "장슈퍼 (장진)", "장일용 (장동민)", "안래퍼 (안유진)", "주만년 (주현영)"], guests: [] },
        { season: "크라임씬 리턴즈", broadcaster: "TVING", year: "2024", otts: ["TVING"], epNum: "4", epTitle: "고시원 살인사건", victim: "황슬우", detective: "키경찰 (KEY)", suspects: ["박주인 (박지윤)", "장슈퍼 (장진)", "장일용 (장동민)", "안래퍼 (안유진)", "주만년 (주현영)"], guests: [] },
        ...
        { season: "크라임씬 리턴즈", broadcaster: "TVING", year: "2024", otts: ["TVING"], epNum: "7", epTitle: "교주 살인사건", victim: "신교주", detective: "안탐정 (안유진)", suspects: ["박기생 (박지윤)", "장뚝딱 (장진)", "장의사 (장동민)", "주모던 (주현영)", "키맹신 (KEY)"], guests: [] },
        { season: "크라임씬 리턴즈", broadcaster: "TVING", year: "2024", otts: ["TVING"], epNum: "8", epTitle: "교주 살인사건", victim: "신교주", detective: "안탐정 (안유진)", suspects: ["박기생 (박지윤)", "장뚝딱 (장진)", "장의사 (장동민)", "주모던 (주현영)", "키맹신 (KEY)"], guests: [] },
        ...
        { season: "크라임씬 제로", broadcaster: "NETFLIX", year: "2025", otts: ["NETFLIX"], epNum: "1", epTitle: "폐병원 살인사건", victim: "장제인", detective: "장탐정 (장진)", suspects: ["박접신 (박지윤)", "장사촌 (장동민)", "김미남 (김지훈)", "안의사 (안유진)"], guests: ["박이장 (박성웅)"] },
        { season: "크라임씬 제로", broadcaster: "NETFLIX", year: "2025", otts: ["NETFLIX"], epNum: "2", epTitle: "폐병원 살인사건", victim: "장제인", detective: "장탐정 (장진)", suspects: ["박접신 (박지윤)", "장사촌 (장동민)", "김미남 (김지훈)", "안의사 (안유진)"], guests: ["박이장 (박성웅)"] },
        { season: "크라임씬 제로", broadcaster: "NETFLIX", year: "2025", otts: ["NETFLIX"], epNum: "3", epTitle: "장례식장 살인사건", victim: "장막둥", detective: "안탐정 (안유진)", suspects: ["박부인 (박지윤)", "장남 (장진)", "장딸 (장동민)", "김연인 (김지훈)"], guests: ["주며늘 (주현영)"] },
        { season: "크라임씬 제로", broadcaster: "NETFLIX", year: "2025", otts: ["NETFLIX"], epNum: "4", epTitle: "장례식장 살인사건", victim: "장막둥", detective: "안탐정 (안유진)", suspects: ["박부인 (박지윤)", "장남 (장진)", "장딸 (장동민)", "김연인 (김지훈)"], guests: ["주며늘 (주현영)"] },
        ...
        { season: "크라임씬 제로", broadcaster: "NETFLIX", year: "2025", otts: ["NETFLIX"], epNum: "7", epTitle: "유흥가 살인사건", victim: "이건준-이건미", detective: "장탐정 (장동민)", suspects: ["박통닭 (박지윤)", "장편돌 (장진)", "김클럽 (김지훈)", "안댄서 (안유진)"], guests: ["하금수 (하석진)"] },
        { season: "크라임씬 제로", broadcaster: "NETFLIX", year: "2025", otts: ["NETFLIX"], epNum: "8", epTitle: "유흥가 살인사건", victim: "이건준-이건미", detective: "장탐정 (장동민)", suspects: ["박통닭 (박지윤)", "장편돌 (장진)", "김클럽 (김지훈)", "안댄서 (안유진)"], guests: ["하금수 (하석진)"] },
...
// 5. 출연진 배지 HTML 생성 함수
function renderCastTag(rawText) {
    if (!rawText || rawText.trim() === '') return '-';
    const { role, actor } = parseCastName(rawText);

    if (role && actor) {
        return `<span class="badge bg-light text-dark keyword-tag mr-1" data-keyword="${actor}">
                    ${role} <small class="text-muted">(${actor})</small>
                </span>`;
    } else {
        return `<span class="badge bg-light text-dark keyword-tag mr-1" data-keyword="${actor}">
                    ${actor}
...
// 6. 키워드 필터 버튼 생성 (피해자 victim도 집계에 포함)
...
function renderKeywordButtons() {
    ...
    programData.crimeScene.forEach(item => {
        // 피해자(victim) 항목은 괄호()가 있어 실제 출연진 매핑이 된 경우만 추출
        ...
        allCasts.forEach(actor => {
            // actor 값이 존재하고 빈 문자열이 아닌 실제 출연진만 집계
            if (actor) {
                actorCounts[actor] = (actorCounts[actor] || 0) + 1;
            }
        });
    ...
    sortedActors.forEach(actor => {
        ...
        $wrap.append(`<button class="btn btn-outline-dark btn-keyword" data-keyword="${actor}">#${actor} <small class="text-muted">(${count})</small></button> `);
    });
}
...
function renderTable(containerId, list) {
    ...
    if (currentKeyword !== 'all') {
        filteredList = list.filter(item => {
            // 피해자도 괄호()가 있는 실제 출연진 태그일 때만 필터 조건 검색 대상에 포함
            const victimActor = (item.victim && item.victim.includes('(')) ? parseCastName(item.victim).actor : null;
    ...
    filteredList.forEach(item => {
        ...
        const victimHtml = (item.victim && item.victim.includes('(')) 
            ? renderCastTag(item.victim) 
            : (item.victim || '-');

        const detectiveHtml = renderCastTag(item.detective);
        const sortedSuspects = sortSuspectsByFrequency(item.suspects);
        const suspectsHtml = sortedSuspects.map(s => renderCastTag(s)).join(' ');
        const guestsHtml = (item.guests && item.guests.length > 0)
            ? item.guests.map(g => renderCastTag(g)).join(' ')
            : '-';
        ...
        //<td data-label="방송사" class="center">${item.broadcaster}</td>
        $tbody.append(trHtml);
    });
}
...
$(function () {
    ...
    $(document).on('click', '.keyword-tag', function () {
        ...
        $(`.btn-keyword[data-keyword="${keyword}"]`).trigger('click');
    });
});